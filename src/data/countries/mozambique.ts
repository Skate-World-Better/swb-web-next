...
export const mozambiqueData: CountryPageData = {
  ...
  why: {
    heading: 'Why did we go to *Maputo?*',
    description:
  ...
  gallery: {
    ...
    description:
      'Here are a few pictures from the journey, from the process and the results of our work. Should you be interested in having one printed on your wall, just let us know! Read the assessment on corruption in Mozambique put together by Martin Louzecky, the founder of SWB, as his diploma work [here](/documents/Corruption-in-Mozambique.pdf).',
