...
export const ethiopiaData: CountryPageData = {
  ...
  about: {
    heading: 'What did we do in *Addis Abeba?*',
    description:
      'For the first time in our existence we decided to go on a mission to a destination, where skateboarding and skate-related activities already have a long history. The capital city of Ethiopia has two standing skateparks where the localy established organization Ethiopia Skate runs their programs. Based on a recommendation from our friends from [Forever Playground Magazine](https://foreverplayground.org/) we decided to contact Israel Dejene, the local hero who runs a suburban based social project called Megabi House, where all street kids are welcome. He is passionate about skateboarding and he even linked up with Tony Hawk, Nyjah Huston and the gang and they went down there back in 2015 to build him a miniramp right on the land of Megabi House. In December 2023 we went down to Addis to continue on the job sparked by Tony and we worked out the space into a full skatepark. It took us two weeks of work day and night in a crew of six people. We left a concrete jungle with obstacles for the most skilled riders but also for the very beginners. We decorated the space with a mozaic, couple plants and two palmtrees. Having left more than twenty complete boards, shoes and couple of concrete tools, we believe that this project will continue to thrive in the years to come!',
    extraDescription: 'SEE MORE OF HIS WORK [HERE!](https://www.megabi.org/megabiskate)',
    image: KidsEthiopia,
    imageCaption:
  ...
  why: {
    heading: 'Why did we go to *Addis*',
    description:
  ...
  gallery: {
    ...
    description:
      'Here are a few pictures from Ethiopia and the construction process. Should you be interested in having one printed on your wall, just let us know!',
